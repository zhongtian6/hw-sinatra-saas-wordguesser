...
class WordGuesserApp < Sinatra::Base
  ...
  post '/guess' do
    ...
    ### YOUR CODE HERE ###
    begin
      guess_status = @game.guess(letter)
  ...
  get '/show' do
    ...
    session[:game_status] = @game.check_win_or_lose
    if session[:game_status] == :win
      redirect '/win'
    elsif session[:game_status] == :lose
      redirect 'lose'
    else
      erb :show
    end
